...
class ContactRepository:
    ...
    def __save_to_file(self, contacts):
        ...
        for contact in contacts:
            f.write(contact._id + SEP + contact.name + SEP + contact.phoneNr + SEP + contact.group + NEWLINE)
    ...
    def getAllFor(self, _group):
        ...
        if len(contacts_in_groups) == 0: raise RepositoryException("Found no contact in group : " + _group)
